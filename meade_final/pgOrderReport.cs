...
{
    public partial class pgOrderReport : Form
    {
        public pgOrderReport()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            this.orderTableAdapter.GetOrderStarting(this.pizzaDBDataSet.order);
        }

        private void button2_Click(object sender, EventArgs e)
        {
            pizzaDBDataSet.EnforceConstraints = false;
            this.orderTableAdapter.GetStatusFinished(this.pizzaDBDataSet.order);
        }
    }
}
